...
>
    ...
    <div class="wrapper app-shell">
        ...
        <div class="app-main d-flex flex-column min-vh-100">
            <x-mobile-top-nav :user="$authUser" />
