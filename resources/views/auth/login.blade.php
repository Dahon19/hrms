<x-guest-layout>
    ...
    <div class="flex h-screen w-full overflow-hidden bg-neutral-50 font-sans text-neutral-900 selection:bg-green-500 selection:text-white" x-data="{ showPassword: false, isLoading: false }">
        <div class="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-neutral-900 px-12 py-16 text-white lg:flex">
            <div class="absolute inset-0 z-0 bg-gradient-to-br from-green-950 via-slate-950 to-emerald-800"></div>
            <div class="absolute left-0 top-0 z-0 h-full w-full pointer-events-none opacity-20 mix-blend-screen">
                <div class="absolute -left-32 -top-32 h-[500px] w-[500px] rounded-full bg-green-500 blur-[100px] animate-float"></div>
                <div class="absolute right-0 top-1/2 h-[400px] w-[400px] rounded-full bg-emerald-400 blur-[100px] animate-float" style="animation-delay: -3s;"></div>
            </div>
        ...
        <div class="relative flex w-full flex-col items-center justify-center bg-white px-6 sm:px-12 lg:w-1/2">
            <div class="w-full max-w-sm animate-fade-scale xl:max-w-md" style="animation-delay: 0.2s; opacity: 0;">
                <div class="mb-10 text-center lg:hidden">
                    <div class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-green-600 shadow-xl">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6" @submit="isLoading = true">
                    ...
                    <div class="relative">
                        ...
                        <div class="group relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 text-neutral-400 transition-colors pointer-events-none group-focus-within:text-green-500">
                            ...
                            <input id="login" type="text" name="login" value="{{ old('login') }}" required autofocus
                                class="block w-full rounded-xl border border-neutral-200 bg-neutral-50/50 py-3 pl-11 pr-4 text-neutral-900 transition-all duration-300 focus:border-green-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-500/20 sm:text-sm @error('login') border-red-500 bg-red-50/30 focus:border-red-500 focus:ring-red-500/20 @enderror"
                    ...
                    <div class="relative">
                        ...
                        <div class="group relative">
                            ...
                            <input id="password" :type="showPassword ? 'text' : 'password'" name="password" required
                                class="block w-full rounded-xl border border-neutral-200 bg-neutral-50/50 py-3 pl-11 pr-12 text-neutral-900 transition-all duration-300 focus:border-green-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-500/20 sm:text-sm @error('password') border-red-500 bg-red-50/30 focus:border-red-500 focus:ring-red-500/20 @enderror"
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <label for="remember_me" class="group flex cursor-pointer items-center">
                            <div class="relative mr-2 flex h-5 w-5 items-center justify-center">
                                <input id="remember_me" type="checkbox" name="remember" class="peer h-5 w-5 cursor-pointer appearance-none rounded-md border-2 border-neutral-300 transition-all checked:border-green-600 checked:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500/30" />
                    ...
                    <button type="submit" :disabled="isLoading"
                        class="relative flex w-full items-center justify-center rounded-xl bg-green-600 px-4 py-3.5 font-semibold text-white shadow-[0_8px_20px_-6px_rgba(22,163,74,0.45)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-green-700 hover:shadow-[0_12px_25px_-8px_rgba(22,163,74,0.55)] focus:outline-none focus:ring-4 focus:ring-green-500/30 disabled:cursor-not-allowed disabled:opacity-70"
                    >
